  ...
  <div v-show="showHomeComment" class="bg">
      ...
      <div>
        <div class="single-content">
          <div class="item-header">
            ...
            <div class="item-info">
              <p class="item-title">{{homeComment.Name}}
    ...
    <div class="footer">
        <div class="foot-content">
          <span class="iconfont icon-like" v-if="dolike === 'unlike'" @click="NoLike()">
          </span>
          <span class="iconfont icon-like-fill" v-else @click="YesLike()">
          </span>
          <span class="footer-text">赞({{count}})</span>
...
<style lang="stylus" scoped>
  ...
  .foot-content
    ...
    line-height :.9rem
    height: 0.9rem
  .icon-like,.icon-edit-square,.icon-like-fill
    font-size: .45rem
  .footer-text
    font-size: .35rem
    margin-left 0.1rem
