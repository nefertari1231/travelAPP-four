      ...
      <div class="warrper">
        ...
        <div class="city-info__hot">
          ...
          <div class="city-info-title">
            <ul class="hotmenu">
              <li class="hot-spot" v-for="hot in infos.hotSpot" :key="hot.id">
        ...
        <div class="city-info__hot">
          ...
          <div class="city-info-title" ref="picWrapper">
            <ul class="hotmenu" ref="ulWidth">
              <li class="hot-spot" v-for="food in infos.foods" :key="food.id">
                <div class="hot-spot-part">
        ...
        <div class="goods_menu">
          ...
          <ul>
            <li class="goods__list-li" v-for="item in infos.place" :key="item.id">
