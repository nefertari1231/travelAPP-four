  ...
  <div class="headlist" ref="wrapper">
    <div>
      ...
      <div>
        ...
        <div class="content-title">详细信息: <span class="content-title-s">{{serverDetail.serverName}}</span></div>
        <div class="content-desc">{{serverDetail.serverDescription}}</div>
        <div class="content-money">价格：￥{{serverDetail.serverPrice}}</div>
        <div class="content-place">出游城市：{{serverDetail.serverPlace}}</div>
        <div class="cut-off2"></div>
      </div>  <!--信息详情-->
      <div>
        <div class="content-banner">
          <div class="banner" @click="handleBannerClick">
            <img class="banner-img" src="static/image/service2.jpg" />
    ...
    <div class="footer">
      <div class="function">
        <div class="thumb border-right">
          <div class="iconfont icon-like" v-if="dolike === 'unlike'" @click="NoLike()"></div>
          <div class="iconfont icon-like-fill" v-else @click="YesLike()"></div>
          <div class="desc">点赞</div>
        </div>
        <div class="like">
          <!--<div class="iconfont icon-shoucang1" v-if="collect === 'uncollect'" @click="NoCollect()"></div>-->
          <!--<div class="inconfont icon-heart" v-else @click="YesCollect()"></div>-->
          <!--<div class="desc">收藏</div>-->
          <div class="iconfont icon-shoucang1"></div>
          <div class="desc" v-if="collect === 'uncollect'" @click="NoCollect()">收藏</div>
          <div class="desc" v-else @click="YesCollect()">已收藏</div>
        </div>
      </div>
